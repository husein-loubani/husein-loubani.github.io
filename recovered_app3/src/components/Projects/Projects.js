...
const projectsByRow = {
  ...
  row1: [
    {
      title: 'Comprehensive Review of 3D Building Reconstruction:<br>Comparative Study of LoD2 Approaches',
      description: 'This review critically evaluates state-of-the-art 3D building reconstruction methods focusing on LoD2. It compares accuracy, complexity, and data requirements across major approaches, and highlights open challenges and research directions in urban modeling.',
      gradient: GRADIENT_PRESETS.BLUE,
      technologies:['3D Reconstruction', 'Level of Detail', 'Urban Modeling', 'Computer Vision', 'Survey', 'Benchmarking'],
      actions: [
        { label: 'Paper (Under Review)', url: 'https://husein-loubani.github.io', primary: true }
      ],
      banner: { text: 'Journal', color: '#3182CE' }
    },
    {
      title: 'Skyline-Guided Alignment of Real 360° Images and Synthetic LoD2<br>for Robust Navigation',
      description: 'This work proposes a novel method aligning real-world 360° panoramic images with synthetic LoD2 3D environments using skyline-based features. It enables accurate localization and robust navigation for autonomous agents in urban digital twins.',
      gradient: GRADIENT_PRESETS.INDIGO,
      technologies: ['Skyline Detection', 'Data Alignment', '360° Vision', 'Virtual Environments', 'Autonomous Navigation', 'Urban Localization'],
      actions: [
        { label: 'Coming Soon (ICRA Submission)', url: 'https://husein-loubani.github.io', primary: true }
      ],
      banner: { text: 'Conference', color: '#4F46E5' }
    },
        {
      title: 'Visuo-Tactile Perception of Object Slippage in<br>In & On-Hand Manipulation Tasks',
      description: 'This thesis presents a novel method for estimating object pose during manipulation using integrated visual and tactile sensing. A deep recurrent neural network (RNN) architecture was developed to address occlusion challenges in robotic grasping. Simulations in PyBullet, multimodal data fusion, and 6D pose estimation were employed to improve manipulation accuracy and prevent slippage.',
      gradient: GRADIENT_PRESETS.PINK,
      technologies: ['Robotics', 'Tactile Sensing', '6D Pose Estimation', 'Deep Learning', 'Recurrent Neural Network', 'Simulation', 'LSTM', 'PyBullet'],
      actions: [
        { label: 'Report', url: 'https://drive.google.com/file/d/1SK8LHNccpnAiSW347AObS7zJ05AEb9ur/view?usp=sharing', primary: false },
        { label: 'Presentation', url: 'https://drive.google.com/file/d/1h1Y3Q_jqvrntvjmY15lEgwCcJQauIc4q/view?usp=sharing', primary: false },
        { label: 'GitHub', url: 'https://github.com/husein-loubani/Machine_Learning_in_the_Industry_4.0_Seminar_SS2020.FAU', primary: false }
      ],
      banner: { text: 'Internship', color: '#EC4899', isLong: true }
    }
  ],
